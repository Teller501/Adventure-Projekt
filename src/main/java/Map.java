...
public class Map {
    ...
    public void createMap(){
        ...
        room2.createEnemy("test", "Kris får en haircut mens hans æder en ordentlig durum, som han bruger som våben", 100, new MeleeWeapon("durum", "med ekstra dres og kød", 3)); // TEST
